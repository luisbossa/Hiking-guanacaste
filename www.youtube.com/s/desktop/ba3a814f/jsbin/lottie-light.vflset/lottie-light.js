    ...
    */
    ...
    function wa(a) {
        this.next = function(b) {
            oa(a.g);
            a.g.h ? b = ta(a, a.g.h.next, b, a.g.o) : (a.g.o(b), b = r(a));
            return b
        };
        this.throw = function(b) {
            oa(a.g);
            a.g.h ? b = ta(a, a.g.h["throw"], b, a.g.o) : (pa(a.g, b), b = r(a));
            return b
        };
    ...
    p("Promise", function(a) {
        ...
        b.prototype.I = function(f) {
            ...
            typeof e == "function" ? this.O(e, f) : this.o(f)
        };
        ...
        b.race = function(f) {
            return new b(function(e, g) {
                for (var k = q(f), n = k.next(); !n.done; n = k.next()) d(n.value).v(e, g)
            })
        };
        b.all = function(f) {
            var e = q(f),
            ...
            return g.done ? d([]) : new b(function(k, n) {
                ...
                var D = [],
                    I = 0;
                do D.push(void 0), I++, d(g.value).v(v(D.length - 1), n), g = e.next(); while (!g.done)
            })
        };
        return b
    });
        ...
        function d(e, g) {
            ...
            if (n && u(e[0], k))
                for (e = 0; e < n.length; e++) {
                    var v = n[e];
                    if (g !== g && v.key !== v.key || g === v.key) return {
                        id: k,
                        list: n,
                        index: e,
                        entry: v
    ...
    */
    ...
    var J = {
            ...
            EXTENSION: new G(function(a) {
                return a.indexOf("chrome-extension://") === 0 || a.indexOf("moz-extension://") === 0 || a.indexOf("ms-browser-extension://") === 0
            }),
            N: H("ftp"),
            T: new G(function(a) {
                return /^[^:]*([/?#]|$)/.test(a)
    ...
    function Na(a, b) {
        ...
        for (var c = 0; c < b.length; ++c) {
            var d = b[c];
            if (d instanceof G && d.Y(a)) return F(a)
        }
    }

    function Oa(a) {
        var b = window;
        if (typeof MediaSource !== "undefined" && a instanceof MediaSource || typeof b.ManagedMediaSource !== "undefined" && a instanceof b.ManagedMediaSource) return F(URL.createObjectURL(a));
        b = a.type;
    ...
    function W(a, b) {
        if (bb(a)) return a;
        a = X(String(a));
        if (b == null ? 0 : b.ya) a = a.replace(/(^|[\r\n\t ]) /g, "$1&#160;");
        if (b == null ? 0 : b.xa) a = a.replace(/(\r\n|\n|\r)/g, "<br>");
        if (b == null ? 0 : b.za) a = a.replace(/(\t+)/g, '<span style="white-space:pre">$1</span>');
        return N(a)
    }
    ...
    Ib.prototype.format = function(a) {
        ...
        a = W(a).toString().replace(new RegExp("\\{" + c + "[\\w&#;]+\\}", "g"), function(d) {
            var l;
            if (l = b.g.get(d)) {
                d = "";
                switch (l.type) {
    ...
    function Ob(a, b, c) {
        ...
        return (c == null ? 0 : c.has(b)) ? c.get(b) : a.l.has(b) ? {
            i: 1
        } : (c = a.m.get(b)) ? c : a.h && [].concat(ma(a.h)).some(function(d) {
            ...
            a: {
                if (g = e.conditions) {
                    ...
                    for (var k = g.next(); !k.done; k = g.next()) {
                        ...
                        n = n.next().value;
                        var v = void 0;
                        if ((k = (v = b.getNamedItem(k)) == null ? void 0 : v.value) && !n.has(k)) {
                            g = !1;
                            break a
                        }
                    }
    ...
    function kc(a, b) {
        ...
        if (!(c = !b)) {
            var d, l;
            c = !(Math.random() < ((l = (d = b.Aa) != null ? d : ic[b.F[0]]) != null ? l : 0))
        }
        if (c || window.SAFEVALUES_REPORTING === !1 || !("DocumentFragment" in window)) return a;
        var m, f;
        Math.random() < ((f = (m = b.wa) != null ? m : jc[b.F[0]]) != null ? f : 0) && lc(b, "HEARTBEAT");
        mc(a, b) || W(a).toString() !== a && lc(b, "H_ESCAPE");
        return a
    }
    ...
    function mc(a, b) {
        try {
            ...
            return lc(b, "H_SLSANITIZE"), !0
        }
        try {
            Y($b, a)
        } catch (c) {
            return lc(b, "H_RSANITIZE"), !0
        }
        try {
            Zb(a)
        } catch (c) {
            return lc(b, "H_SANITIZE"), !0
        }
        return !1
    }

    function lc(a, b) {
        (nc ? nc : typeof window !== "undefined" && window.navigator && window.navigator.sendBeacon !== void 0 ? navigator.sendBeacon.bind(navigator) : oc)("https://csp.withgoogle.com/csp/lcreport/" + a.F, JSON.stringify({
    ...
    w("safevalues_raw.scriptUrlToHtml", function(a, b) {
        ...
        (b == null ? void 0 : b.attributionSrc) !== void 0 && (a += ' attributionsrc="' + X(b.attributionSrc) + '"');
        if (b == null ? 0 : b.V) a += ' custom-element="' + X(b.V) + '"';
        ...
        if (b == null ? 0 : b.U) a += ' crossorigin="' + X(b.U) + '"';
        return N(a +
            ">\x3c/script>")
    });
    ...
    w("safevalues_raw.safeScriptWithArgs", function(a) {
        return function() {
            var b = t.apply(0, arguments).map(function(c) {
                return hc(c).toString()
            });
            return T("(" + a.join("") + ")(" + b.join(",") + ")")
        }
    });
    w("safevalues_raw.valueAsScript", hc);
    ...
    w("safevalues_raw.safeUrl", function(a) {
        for (var b = t.apply(1, arguments), c = [a[0]], d = 0; d < b.length; d++) c.push(String(b[d])), c.push(a[d + 1]);
        return F(c.join(""))
    });
    ...
    w("safevalues_raw.reportOnlyHtmlPassthrough", kc);
    ...
    w("safevalues_raw.safeStyleRule", function(a) {
        for (var b = t.apply(1, arguments), c = a[0], d = 0; d < a.length - 1; d++) c += String(b[d]), c += a[d + 1];
        b = document.implementation.createHTMLDocument("");
        d = b.createElement("style");
        b.head.appendChild(d);
        b = d.sheet;
        b.insertRule(c, 0);
        if (b.cssRules.length === 1 && (c = b.cssRules[0], c instanceof CSSStyleRule)) return V(c.cssText.replace(/</g, "\\3C "))
    });
    ...
    w("safevalues_raw.dom.setIframeSrcWithIntent", function(a, b, c) {
        ...
        switch (b) {
            ...
            case 1:
                ...
                Q(a, "allow-same-origin allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-storage-access-by-user-activation".split(" "));
                cb(a, c);
                break;
            case 2:
    ...
    w("safevalues_raw.dom.setIframeSrcdocWithIntent", function(a, b, c) {
        ...
        switch (b) {
            ...
            case 2:
                ...
                Q(a, ["allow-scripts", "allow-forms", "allow-popups",
    ...
    w("safevalues_raw.dom.workerGlobalScopeImportScripts", function(a) {
        a.importScripts.apply(a, ma(t.apply(1, arguments).map(function(b) {
            return C(b)
        })))
    });
    ...
    w("safevalues_raw.restricted.legacy.superLenientlySanitizeHtml", function(a) {
        return Y(ac, a)
    });
